...
Background: previous sessions have been added to the database
  ...
  Given the following courses have been added:
    | name    | session       | description | days_of_week  | start_time_hour   | start_time_minute | start_time_type   | class_min | class_max | grade_range   | fee_per_meeting   | fee_for_additional_materials  |
