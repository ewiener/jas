...
Background: populate db with a single class session
  ...
  | classroom3      | lastname3 | jim@a.com | 4156891212| 12 Cedar Lane | Some info | Fall 2011 |
  ...
  Given the following courses have been added:
    ...
    | Artistic Dance     | Fall 2011     | art class   | 2:10pm            | 5         | 15        | K-5           | 10                | 15                            | true      | false       | false     | false     | false     | 3:10pm     | false | false | 12 | 122 | classroom3 | room3 |
...
Scenario: Create New Class
  ...
  And I fill in the new create class form correctly with subject "Math", pta instructor "classroom3", and classroom "room3"
