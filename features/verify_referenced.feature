...
Scenario: Verify classroom classroom cannot be deleted, because referenced twice
  Given I am on the "Fall 2011" Classroom Classrooms home page
  Then I should see "Referenced" 2 times
  
Scenario: Delete student, then check if that classroom classroom can be deleted
...
Scenario: Delete course, then check if that classroom classroom and the pta instructor can be deleted
...
Scenario: Delete both course and student, verify that all pta instructors and classroom classrooms can be deleted
  Given I am on the "Fall 2011" Students home page
  And I press "Delete"
  Given I am on the "Fall 2011" Course Page
  And I press "Delete"
